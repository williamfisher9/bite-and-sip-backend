...
public class FoodCategory implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        return active == that.active && Objects.equals(id, that.id) && Objects.equals(name, that.name) && Objects.equals(imageSource, that.imageSource);
    }

    @Override
    public int hashCode() {
        return Objects.hash(id, name, imageSource, active);
    }
